...
function ModalCreateEditApplicationLandlord(props) {
                ...
                <div className="px-5 py-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div>
                            ...
                            <select id="status" className="form-input w-full px-2 py-1" value={state.application?.status} onChange={handleChange} required>
                                <option value={null}>Select an option</option>
                        ...
                        <div>
                            ...
                            <input id="feedback" className="form-input w-full px-2 py-1" type="email" value={state.application.feedback || ""} placeholder='The landlord can give you a feedback' onChange={handleChange} />
                        </div>
                    </div>
...
export default ModalCreateEditApplicationLandlord;